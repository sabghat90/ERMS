...
interface TaskRepository {
    ...
    suspend fun getTask(id: Int, result: (UiState<TaskModel>) -> Unit)
    suspend fun createTask(task: TaskModel, result: (UiState<Pair<TaskModel, String>>) -> Unit)
    suspend fun updateTask(task: TaskModel, result: (UiState<Pair<TaskModel, String>>) -> Unit)
    suspend fun deleteTask(id: Int, result: (UiState<Pair<TaskModel, String>>) -> Unit)
}